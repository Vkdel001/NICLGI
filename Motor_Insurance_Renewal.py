...
def create_page2_renewal(c, data, qr_filename):
    ...
    if os.path.exists("NICLOGO.jpg"):
        ...
        print(f"📍 Logo position: x={nic_logo_x}, y={nic_logo_y}, w={nic_logo_width}, h={nic_logo_height}")
        c.drawImage(nic_logo_img, nic_logo_x, nic_logo_y, width=nic_logo_width, height=nic_logo_height)
        print("✅ Logo drawn successfully!")
        
        # Start content below the NIC logo
        y_pos = nic_logo_y - 12  # Same spacing as healthcare
    else:
    ...
    if qr_filename and os.path.exists(qr_filename):
        qr_size = 100  # Optimal size for page fit
